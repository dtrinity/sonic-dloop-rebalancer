...
describe("Integration Tests", function () {
  ...
  describe("Configuration validation", function () {
    ...
    it("should respect different minimum subsidy thresholds", async function () {
      ...
      highSubsidyConfig.policy.minSubsidyAmount[debtTokenAddress] = ethers
        .parseEther("1000")
        .toString(); // 1000 dUSD minimum

      const highSubsidyManager = new RebalanceManager(
        contractManager,
        highSubsidyConfig,
      );
...
/* eslint-enable @typescript-eslint/no-unsafe-call, @typescript-eslint/no-unsafe-member-access -- re-enable rules after test file */
